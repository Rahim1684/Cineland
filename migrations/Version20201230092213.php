 ...
 */
final class Version20201230092213 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE film (id INT AUTO_INCREMENT NOT NULL, genre_id INT NOT NULL, titre VARCHAR(255) NOT NULL, duree DOUBLE PRECISION NOT NULL, date_sortie DATE NOT NULL, note SMALLINT NOT NULL, age_minimal SMALLINT NOT NULL, UNIQUE INDEX UNIQ_8244BE22FF7747B4 (titre), INDEX IDX_8244BE224296D31F (genre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
